...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(url, accessToken, function (err, body, res) {
    ...
    try {
      ...
      profile.id = json.data.login;
      profile.fullName = json.data.full_name;
      profile.displayName = json.data.display_name;
      profile.profileUrl = json.data.profile_url;
      profile.profileImage = json.data.profile_image;
